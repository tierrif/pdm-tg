...
@Entity(foreignKeys = [ForeignKey(TaskList::class, ["idTask"], ["idTaskList"],
...
@Entity(foreignKeys = [ForeignKey(Task::class, ["idReminder"], ["idTask"],
    ForeignKey.CASCADE, ForeignKey.CASCADE)])
data class Reminder(
...
@Entity(foreignKeys = [ForeignKey(Task::class, ["idTask"], ["idTask"],
    ForeignKey.CASCADE, ForeignKey.CASCADE), ForeignKey(Tag::class, ["idTag"], ["idTag"],
    ForeignKey.CASCADE, ForeignKey.CASCADE)])
data class TaskTag(
    val idTask: Int,
    val idTag: Int,
